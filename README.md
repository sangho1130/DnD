...
4. Preprocessed bam files from step 1 were analyzed using MACS2 (version 2.2.9.1) to call peaks with -f BAM --nomodel parameters. Peaks were then filtered with blacklist region annotation using bedtools (version 2.31.1) (Quinlan and Hall 2010). Motif analysis was performed using MEME Simple Enrichment Analysis (SEA) (Bailey and Grant 2021) with HOmo sapiens COmprehensive MOdel COllection (HOCOMOCO) (Kulakovskiy et al. 2018) v11 core motif set to identify binding sites in peaks. Optionally, users can perform motif analysis using HOMER2 (https://doi.org/10.1038/s41586-024-07662-z) or a reference bed file generated by ChIP-seq.
