...
def build_parser():
	...
	parser.add_argument('--genomeOrder', help = '[Global] (*optional) chromosome ordered in bed; default is </data/GRCh38.p14.genome.chrs.bed>', default = None)
...
def main(args=None):
	...
	if args.genomeOrder == None:
		args.genomeOrder = str(importlib.resources.files("main")) + "/data/GRCh38.p14.genome.chrs.bed"

	for sample in samples:
		tf_peaks(args.mode, bdt, hm2, args.hm2ref, sample, args.motif, args.chipseq, args.size, args.Dir, args.Output, args.indiv)
		stats_peaks(args.mode, bdt, v2b, sample, args.size, args.rand, args.Dir, args.Output, args.variants, args.genomeOrder)
